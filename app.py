...
<h4>{}</h4>
<p style="color:blue;"><span style="color:black;">📈Stream::</span>{}</p>
<p style="color:blue;"><span style="color:black;">Course:</span>{}</p>
...
def main():
	...
	df = load_data("Downloades/StudentsData.csv")
